    ...
    >
      ...
      >
        <div className="flex flex-col space-y-1.5 p-6 border-b border-slate-100">
          <h3 className="font-semibold leading-none tracking-tight text-lg">Editar Contato</h3>
          <p className="text-sm text-slate-500">
            {contactName || 'Contato sem nome'} <span className="font-mono text-[12px] text-slate-400">· {contactNumber}</span>
          </p>
        </div>
