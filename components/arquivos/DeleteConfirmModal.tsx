    ...
    >
      ...
      >
        <div className="p-6 text-center overflow-y-auto">
          ...
          <DeleteReasonFields value={reason} onChange={setReason} id="arquivos-delete-reason" />
        </div>
        <div className="p-4 bg-slate-50 border-t border-slate-100 flex gap-2 shrink-0">
          ...
          <button
            ...
            className="flex-1 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors bg-red-600 text-white hover:bg-red-700 h-10 px-4 disabled:opacity-50 disabled:pointer-events-none"
          >
            Confirmar
          </button>
        </div>
