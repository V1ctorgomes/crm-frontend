...
export function PasswordResetRequestsPanel({
  ...
  return (
    <>
      <div className="mx-6 md:mx-8 mb-6 rounded-xl border border-sky-200 bg-sky-50/90 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 border-b border-sky-200/80 bg-sky-100/60 px-4 py-3">
          <KeyRound className="h-5 w-5 text-sky-800 shrink-0" />
          <div>
          ...
          {requests.map((r) => (
            ...
            >
              <div className="min-w-0">
                <p className="font-semibold text-brand-950 truncate">{r.user.name}</p>
                <p className="text-xs text-slate-600 truncate">{r.user.email}</p>
              ...
              <button
                ...
                className="inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-lg bg-sky-700 px-4 text-xs font-semibold text-white hover:bg-sky-800 transition-colors"
              >
