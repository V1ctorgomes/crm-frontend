      ...
      >
        <div className="p-6 text-center overflow-y-auto">
          ...
          <p className="text-sm text-slate-500">
            Esta mensagem será removida <strong>para todos</strong> no WhatsApp. Só é possível até{' '}
            <strong>50 horas</strong> após o envio.
          </p>
          ...
          <DeleteReasonFields value={reason} onChange={setReason} id="wa-delete-msg-reason" />
        </div>
