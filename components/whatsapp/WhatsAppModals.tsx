  ...
  >
    ...
    >
      ...
      <div className="p-6 flex flex-col gap-4">
        <p className="text-xs text-slate-500 -mt-1">Todos os campos são obrigatórios. CPF/CNPJ e e-mail são validados automaticamente.</p>
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1 space-y-1">
            <label className="text-sm font-medium text-slate-700">Tipo de OS *</label>
            <input
              type="text"
              className="h-10 w-full rounded-md border border-slate-300 px-3 text-sm focus:outline-none focus:border-brand-600 focus:ring-1 focus:ring-brand-600"
      ...
      <div className="p-4 border-t border-slate-100 flex justify-end gap-2 bg-slate-50 shrink-0">
        ...
        <button type="button" onClick={handleCreateTicket} className="bg-brand-600 text-white px-4 h-10 rounded-md font-medium hover:bg-brand-700 transition-colors text-sm">
          Criar OS
        </button>
      </div>
    </div>
