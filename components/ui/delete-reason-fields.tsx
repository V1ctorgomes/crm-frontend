...
import { crmUserIsDeveloper, MIN_DELETE_REASON_LENGTH } from '@/lib/delete-reason-policy';
    ...
    <div className="mt-4 w-full text-left">
      ...
      <div className="flex flex-wrap items-center justify-between gap-x-2 gap-y-0.5 mt-1.5">
        <p className="text-[11px] text-slate-500">
          Mínimo <strong className="text-slate-700">{MIN_DELETE_REASON_LENGTH}</strong> caracteres úteis (sem espaços à
          volta).
        </p>
        <p
          className={`text-[11px] font-medium tabular-nums ${metMin ? 'text-emerald-600' : 'text-amber-700'}`}
          aria-live="polite"
        >
